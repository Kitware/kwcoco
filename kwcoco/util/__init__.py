...
if sys.version_info[0:2] <= (3, 6):
    ...
    from kwcoco.util.dict_like import (
        DictLike,
    )
    from kwcoco.util.jsonschema_elements import (
        ALLOF,
        ANY,
        ANYOF,
        ARRAY,
    ...
    from kwcoco.util.util_archive import (
        Archive,
        unarchive_file,
    )
    from kwcoco.util.util_json import (
        IndexableWalker,
        ensure_json_serializable,
        find_json_unserializable,
        indexable_allclose,
    )
    from kwcoco.util.util_reroot import (
        resolve_directory_symlinks,
        resolve_relative_to,
        special_reroot_single,
    )
    from kwcoco.util.util_sklearn import (
        StratifiedGroupKFold,
    )
    from kwcoco.util.util_truncate import (
        smart_truncate,
    )
