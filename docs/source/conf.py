...
mod_dpath = join(repo_dpath, 'kwcoco')
...
# html_logo = '.static/kwcoco.svg'
# html_favicon = '.static/kwcoco.ico'
...
latex_documents = [
    (master_doc, 'kwcoco.tex', 'kwcoco Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'kwcoco', 'kwcoco Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'kwcoco', 'kwcoco Documentation',
     author, 'kwcoco', 'One line description of project.',
     'Miscellaneous'),
]
