...
class CocoVisualizeConfig(scfg.DataConfig):
    ...
    __default__ = {
        ...
        'darken_images': scfg.Value(False, help='if specified, darken the images so annotations stand out better'),
...
def main(cmdline=True, **kwargs):
    ...
    for vidid, video in prog:
        ...
        common_kw = ub.udict(config) & {
            ...
            'draw_track_trails', 'stack_axis', 'darken_images',
        }
    ...
    for chan_row in chan_groups:
        ...
        try:
            stack_img_item, stack_ann_item = draw_chan_group(
                ...
                ann_score_thresh, alpha, darken_images,
            )
            if stack:
...
def draw_chan_group(coco_dset, frame_id, name, ann_view_dpath, img_view_dpath,
                    ...
                    request_roles, ann_score_thresh, alpha, darken_images):
    """
